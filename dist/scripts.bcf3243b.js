...
(function () {
  document.querySelectorAll('[class*="from:"]').forEach( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(el) {
      var _el$className$match, _el$className$match2, value;

      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _el$className$match = el.className.match(/(from:)([^\s]+)/), _el$className$match2 = _slicedToArray(_el$className$match, 3), value = _el$className$match2[2];
...
(function () {
  document.querySelectorAll("a.animate-header").forEach(function (el) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                evt.preventDefault();
                document.querySelector("header > div.transition-transform").classList.add("-translate-y-full");
                _context2.next = 4;
                return wait(1000);
...
(function () {
  ...
  var observer = new IntersectionObserver(function (entries) {
    var attach = entries[0].boundingClientRect.y < 0;
